...
require (
	...
	github.com/networkservicemesh/sdk-vpp v0.0.0-20230220111951-932b5f89c1fd
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v0.0.0-20230220111302-8cacff1b23b3 // indirect
