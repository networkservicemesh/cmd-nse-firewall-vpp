...
require (
	...
	github.com/networkservicemesh/sdk-vpp v0.0.0-20220914234304-1eab282306b2
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v0.0.0-20220914233809-d1f08e0e6986 // indirect
