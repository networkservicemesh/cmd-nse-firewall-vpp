...
require (
	...
	github.com/networkservicemesh/sdk-vpp v0.0.0-20221012143526-6bf4fcd3e12d
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v0.0.0-20221012143125-a9204564bbb3 // indirect
