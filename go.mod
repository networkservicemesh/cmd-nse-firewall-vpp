...
require (
	...
	github.com/networkservicemesh/sdk-vpp v0.0.0-20230216094257-d52947453bfd
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v0.0.0-20230216093904-7fc74a700232 // indirect
