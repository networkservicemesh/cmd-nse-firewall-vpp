...
require (
	...
	github.com/networkservicemesh/sdk-vpp v0.0.0-20230516144810-dfed96c7267c
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v0.0.0-20230516144344-fe1d5511d181 // indirect
