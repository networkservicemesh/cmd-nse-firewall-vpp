...
require (
	...
	github.com/networkservicemesh/sdk-vpp v0.0.0-20220712111740-1dfb5825a3b6
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v0.0.0-20220712111253-d45ad9459db3 // indirect
