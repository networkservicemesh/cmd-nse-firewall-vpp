...
require (
	...
	github.com/networkservicemesh/api v1.6.0-rc.2
	github.com/networkservicemesh/sdk v1.6.0-rc.2
	github.com/networkservicemesh/sdk-vpp v1.6.0-rc.2
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v1.6.0-rc.2 // indirect
