...
require (
	...
	github.com/networkservicemesh/sdk-vpp v0.0.0-20220704122758-8bf2aa3a17ac
...
require (
	...
	github.com/networkservicemesh/sdk-kernel v0.0.0-20220704121914-75c5e0fd3acd // indirect
